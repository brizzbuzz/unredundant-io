...
import image4 from '@/images/photos/cyberpunk-portrait-mystic-child.jpg'
import image5 from '@/images/photos/cyberpunk-portrait-woman-warrior.jpg'
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/unredundant"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://ryanbr.ink"
              aria-label="Follow on Polywork"
              icon={PolyworkIcon}
            />
          </div>
        </div>
